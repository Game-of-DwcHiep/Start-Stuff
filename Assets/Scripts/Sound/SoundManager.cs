...
public class SoundManager : MonoSingleton<SoundManager>, ISaveable
{
    #region Classes
    ...
    public AudioSource audiohand = null;
    #endregion
    ...
    // new
    public void PlaySoundHandTouch()// su dung khi cham tay vao xep chu
    {
        audiohand.Play();
        audiohand.pitch += 0.15f;
    }
    public void ResetSoundHandTouch() // reset lai pitch khi thoat ra
    {
        audiohand.pitch = 1f;
    }
    ...
    {
        audiohand.volume = 1;// dieu chinh lai volume = 1 khi bat lai sound
        for (int i = 0; i < soundInfos.Count; i++)
        {
            SoundInfo soundInfo = soundInfos[i];
    ...
    {
        audiohand.volume = 0;// dieu chinh lai volume = 0 thi tat sound
        for (int i = 0; i < playingSounds.Count; i++)
        {
            PlayingSound playingSound = playingSounds[i];
